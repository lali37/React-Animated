...
const Navbar = () => {
  ...
  return (
    <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
        ...
        className='lg:h-10 h-7 bg-black relative lg:w-[14vw] w-30'>
            <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
            <div className='relative h-full lg:px-10 px-6 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
